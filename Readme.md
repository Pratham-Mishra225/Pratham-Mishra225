...
class Engineer:
    def __init__(self):
        ...
        self.university  = "<YOUR_UNIVERSITY>"
        self.year        = "<YOUR_YEAR> Year"
...
<img src="https://leetcard.jacoblin.cool/<YOUR_LEETCODE>?theme=dark&font=baloo&ext=heatmap" width="80%" />
...
> Open to **internships**, **open-source collaboration**, and **interesting conversations**.
...
⭐ **From [<YOUR_GITHUB>](https://github.com/<YOUR_GITHUB>)** — *if you like what you see, consider starring a repo!*
